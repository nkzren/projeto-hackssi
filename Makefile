...
help:
	@echo -e "PAND - \x1b[1;4;33mMakefile\x1b[m"
	@echo
	...
	@echo -e "- \x1b[1;4mstop\x1b[m  to stop the running containers"
	@echo -e "- \x1b[1;4mclean\x1b[m to clear the docker environment"
